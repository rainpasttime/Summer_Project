...
function changeImg(){
	...
	// img.src="../image/"+curIndex+".jpg";  

	img.style='background:url(../image/'+curIndex+'.jpg) 50% 50% no-repeat;background-size: cover;height:850px;';
...
function showDialog(){
	...
	autoCenter( g('dialog_login') );
	fillToBody( g('dialog_login') );
